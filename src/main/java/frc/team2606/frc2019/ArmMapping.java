...
import frc.team2606.frc2019.states.SuperstructureConstants;
...
public class ArmMapping {
    ...
    public void armMapInit(){
        for (int i = 0; i<=180; i++){
            armMap.put(i, "Length;" + df.format((SuperstructureConstants.ARM_LENGTH*Math.sin(i*(Math.PI/180)))) + ":Height;" + df.format((SuperstructureConstants.ARM_LENGTH*Math.cos(i*(Math.PI/180)))));
        }
    }
